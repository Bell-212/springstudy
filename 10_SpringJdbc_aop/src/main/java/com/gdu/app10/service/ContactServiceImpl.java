...
@RequiredArgsConstructor  // private final ContactDao contactDao에 @Autowired를 하기 위함
@Service  // ContactService 타입의 객체(Bean)를 Spring Container에 저장한다.
public class ContactServiceImpl implements ContactService {
  ...
  public void txTest() {
    ...
    // 실패
    contactDao.insert(new ContactDto()); // NAME 칼럼은 NOT NULL이므로 전달된 이름이 없으면 실패한다.
  }
