...
CREATE TABLE BLOG_T (
    ...
    USER_NO     NUMBER             NOT NULL,  -- 작성자 번호(NULL인 경우 ON DELETE SET NULL 처리가 가능하고, NOT NULL인 경우 ON DELETE CASCADE 처리 가능하다.)
...
-- 블로그 댓글(계층형-1차, 댓글 작성 가능/대댓글 불가능)
...
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user1@naver.com', '내용6', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user1@naver.com', '내용7', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user1@naver.com', '내용8', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user3@naver.com', '내용9', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용10', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
...
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user3@naver.com', '내용13', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용14', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user3@naver.com', '내용15', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용16', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용17', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
INSERT INTO FREE_T VALUES(FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용18', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
...
-- 첨부 테이블 정보를 조회하지 않는다면 업로드 - 첨부 조인을 제거하고 작업을 수행할 수 있음
...
-- 내부 : 사용자와 블로그 모두 존재하는 데이터를 조인하는 방식
-- 외부 : 사용자가 없는 블로그도 모두 조인하는 방식 (현재 불가능, USER_T의 USER_NO가 NOT NULL이다.)
--        블로그가 없는 사용자도 모두 조인하는 방식 (현재 필요 없는 방식)
